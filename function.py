...
def generate_rsa_key(username):
    ...
    public_key_filename = f'public_key_{user_identifier}.pem'
    ...
    private_key_filename = f'private_key_{user_identifier}.pem'
...
def get_public_key(username):
    try:
        filename = f"{username}_public.pem"
...
def get_private_key(username):
    try:
        filename = f"{username}_private.pem"
        with open(filename, 'rb') as file:
